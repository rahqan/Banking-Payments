       ...
       new Admin
       {
           ...
           Password = "admin123"
            ...
            modelBuilder.Entity<Payment>().HasData(
                new Payment {PaymentId=1, Amount = 12500, PaymentDate = DateTime.Now.AddDays(-10), Type = PaymentType.NEFT, status = Banking_Payments.Models.Enums.VerificationStatus.Verified, Remarks = "Monthly IT Contract", ClientId = 1, BeneficiaryId = 1, BankUserId = 1 },
