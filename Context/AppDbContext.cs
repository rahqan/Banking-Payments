...
namespace Banking_Payments.Context
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // BANKS
            modelBuilder.Entity<Bank>().HasData(
                new Bank { BankId = 1, Code = "B001", Name = "First National Bank", Address = "123 Finance St", PanNumber = "AAAPL1234C", RegistrationNumber = "REG001", ContactEmail = "info@fnb.com", ContactPhone = "1234567890", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 1 },
                new Bank { BankId = 2, Code = "B002", Name = "Global Trust Bank", Address = "456 Trust Ave", PanNumber = "BBBTY4567P", RegistrationNumber = "REG002", ContactEmail = "contact@gtb.com", ContactPhone = "9876543210", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 2 },
                new Bank { BankId = 3, Code = "B003", Name = "Metro Finance Bank", Address = "789 Metro Rd", PanNumber = "CCCXY7890K", RegistrationNumber = "REG003", ContactEmail = "support@mfb.com", ContactPhone = "5647382910", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 3 },
                new Bank { BankId = 4, Code = "B004", Name = "Unity Bank", Address = "88 Liberty Ln", PanNumber = "DDDPL2234J", RegistrationNumber = "REG004", ContactEmail = "help@unity.com", ContactPhone = "9898989898", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 4 },
                new Bank { BankId = 5, Code = "B005", Name = "Central Credit Bank", Address = "22 Market Rd", PanNumber = "EEERW5567L", RegistrationNumber = "REG005", ContactEmail = "info@ccb.com", ContactPhone = "9000090000", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 5 },
                new Bank { BankId = 6, Code = "B006", Name = "Prime Finance Corp", Address = "47 Prime Blvd", PanNumber = "FFFTR2233N", RegistrationNumber = "REG006", ContactEmail = "contact@prime.com", ContactPhone = "8765432190", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 6 },
                new Bank { BankId = 7, Code = "B007", Name = "Eco Savings Bank", Address = "12 Green St", PanNumber = "GGGTY8907M", RegistrationNumber = "REG007", ContactEmail = "eco@esb.com", ContactPhone = "9123456789", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 7 },
                new Bank { BankId = 8, Code = "B008", Name = "Liberty Bank", Address = "7 Freedom Way", PanNumber = "HHHPL5678V", RegistrationNumber = "REG008", ContactEmail = "info@liberty.com", ContactPhone = "9234567890", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 8 },
                new Bank { BankId = 9, Code = "B009", Name = "Heritage Finance", Address = "4 Heritage Square", PanNumber = "IIIWR3456C", RegistrationNumber = "REG009", ContactEmail = "support@heritage.com", ContactPhone = "9345678901", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 9 },
                new Bank { BankId = 10, Code = "B010", Name = "Crescent Capital Bank", Address = "55 Moonlight Rd", PanNumber = "JJJER5647R", RegistrationNumber = "REG010", ContactEmail = "hello@crescent.com", ContactPhone = "9456789012", IsActive = true, CreatedAt = DateTime.UtcNow, CreatedByAdminId = 10 }
            );
