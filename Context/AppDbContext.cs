...
namespace dummy_api.Context
{
    ...
    new Payment { PaymentId = 1, Amount = 10000, PaymentDate = new DateTime(2025, 01, 01), status = 1, Type = PaymentType.NEFT, BeneficiaryId = 1, ClientId = 1, BankUserId = 1 },
    new Payment { PaymentId = 2, Amount = 25000, PaymentDate = new DateTime(2025, 01, 01), status = 1, Type = PaymentType.RTGS, BeneficiaryId = 2, ClientId = 2, BankUserId = 2 },
    new Payment { PaymentId = 3, Amount = 5000, PaymentDate = new DateTime(2025, 01, 01), status = 0, Type = PaymentType.IMPS, BeneficiaryId = 3, ClientId = 3, BankUserId = 3 }
);
